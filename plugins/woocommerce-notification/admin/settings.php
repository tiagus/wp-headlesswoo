                ...
                <div class="vi-ui bottom attached tab segment" data-tab="products">
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top" class="vi_hidden latest-product-select-categories">
                            ...
                            <td>
                                <input id="<?php echo self::set_field( 'limit_product' ) ?>" type="number" tabindex="0" min="0"
                            ...
                            <td>
                                <div class="vi-ui form">
                                    <div class="inline fields">
                                        <input type="number" name="<?php echo self::set_field( 'virtual_time' ) ?>" min="0"
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <input type="number" min="0" max="20" name="<?php echo self::set_field( 'image_padding' ) ?>"
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="time">
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top" class="vi_hidden time_loop">
                            ...
                            <td>
                                <input type="number" name="<?php echo self::set_field( 'loop_session_total' ) ?>" min="0"
                        ...
                        <tr valign="top" class="vi_hidden time_loop">
                            ...
                            <td>
                                <input type="number" name="<?php echo self::set_field( 'notification_per_page' ) ?>" min="0"
                        ...
                        <tr valign="top" class="vi_hidden initial_delay_random">
                            ...
                            <td>
                                <div class="vi-ui form">
                                    <div class="inline fields">
                                        <input type="number" name="<?php echo self::set_field( 'initial_delay_min' ) ?>" min="0"
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="messages">
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input id="<?php echo self::set_field( 'min_number' ) ?>" type="number" tabindex="0" min="0"
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input id="<?php echo self::set_field( 'max_number' ) ?>" type="number" tabindex="0" min="0"
