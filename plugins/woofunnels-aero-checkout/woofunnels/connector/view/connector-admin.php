...
?>
    <div class="wrap wfco_connectors_listing wfco_global">
        <div class="wfco_head_bar">
            <div class="wfco_bar_head"><?php _e( 'WooFunnels Connectors', 'woofunnels' ); ?></div>
        </div>
        <div id="poststuff">
            <div class="inside">
                    ...
                    <div class="wfco_connector_listing_wrap wfco_clearfix">
                        <div class="wfco-row">
                            <form method="GET">
								...
								<?php
								WFCO_Connector_Screen_Factory::print_screens();
								?>
                            </form>
                        </div>
                    </div>
    ...
    <div class="wfco_izimodal_default" style="display: none" id="wfco-modal-connect">
        <div class="sections">
            <form class="wfco_add_connector" id="wfco-autoresponder" method="post" data-wfoaction="save_connector">
            ...
            <div class="wfco-connector-create-success-wrap wfco-display-none">
                ...
                <div class="wfco-connector-connect-message"><?php _e( 'Connector connected successfully. Redirecting the page...', 'woofunnels' ); ?></div>
            </div>
        </div>
    </div>
    <div class="wfco_izimodal_default" style="display: none" id="modal-edit-connector">
        <div class="sections">
            <form class="wfco_update_connector" id="wfco-autoresponder" method="post" data-wfoaction="update_connector">
                <div class="wfco_vue_forms" id="part-add-funnel">
            ...
            <div class="wfco-automation-update-success-wrap wfco-display-none">
                ...
                <div class="wfco-automation-update-message"><?php _e( 'We have detected change in the connector during updation.', 'woofunnels' ); ?></div>
            </div>
        </div>
    </div>
<?php
