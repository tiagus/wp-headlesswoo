...
$header_layout = $headers['header_layout'];


?>


<header class="wfacp-header wfacp_header <?php echo $rbox_border_type . ' ' . $header_layout; ?>">
                ...
                <div class="wfacp-header-nav clearfix">
                    <ul>
						...
						if ( isset( $headers['header_data']['header_text'] ) && $headers['header_data']['header_text'] != '' ) {
							...
							?>
                            <li class="wfacp_header_list_sup"><span class="wfacp-hd-list-sup"><?php echo $headers['header_data']['header_text']; ?></span></li>
