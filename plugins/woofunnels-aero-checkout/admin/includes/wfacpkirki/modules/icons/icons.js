/* global wfacpkirkiIcons */
jQuery( document ).ready( function() {

	'use strict';

	if ( ! _.isUndefined( wfacpkirkiIcons.section ) ) {

		// Parse sections and add icons.
		_.each( wfacpkirkiIcons.section, function( icon, sectionID ) {
	...
	if ( ! _.isUndefined( wfacpkirkiIcons.panel ) ) {

		_.each( wfacpkirkiIcons.panel, function( icon, panelID ) {
