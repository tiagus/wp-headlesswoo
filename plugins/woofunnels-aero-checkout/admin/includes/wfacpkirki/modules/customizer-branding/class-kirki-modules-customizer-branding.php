...
class WFACPKirki_Modules_Customizer_Branding {
	...
	public function customize_controls_print_scripts() {
		...
		if ( ! empty( $vars['logoImage'] ) || ! empty( $vars['description'] ) ) {
			wp_register_script( 'wfacpkirki-branding', WFACPKirki::$url . '/modules/customizer-branding/branding.js', array(), WFACP_KIRKI_VERSION );
			wp_localize_script( 'wfacpkirki-branding', 'wfacpkirkiBranding', $vars );
			wp_enqueue_script( 'wfacpkirki-branding' );
		}
	}
}
