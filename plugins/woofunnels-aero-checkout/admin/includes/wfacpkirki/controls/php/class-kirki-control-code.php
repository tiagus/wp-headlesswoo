...
if ( ! class_exists( 'WP_Customize_Code_Editor_Control' ) ) {
	...
	class WFACPKirki_Control_Code extends WFACPKirki_Control_Base {
		...
		protected function content_template() {
			...
			<div class="notice notice-error" data-type="error"><div class="notification-message">
				<?php esc_attr_e( 'Please update your WordPress installation to a version newer than 4.9 to access the code control.', 'wfacpkirki' ); ?>
			</div></div>
			<?php
		}
	}
	 ...
	 */
	class WFACPKirki_Control_Code extends WP_Customize_Code_Editor_Control {}
}
