...
class WFACPKirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		// Enqueue ColorPicker.
		wp_enqueue_script( 'wp-color-picker-alpha', trailingslashit( WFACPKirki::$url ) . 'assets/vendor/wp-color-picker-alpha/wp-color-picker-alpha.js', array( 'wp-color-picker' ), WFACP_KIRKI_VERSION, true );
		wp_enqueue_style( 'wp-color-picker' );

		// Enqueue selectWoo.
		wp_enqueue_script( 'selectWoo', trailingslashit( WFACPKirki::$url ) . 'assets/vendor/selectWoo/js/selectWoo.full.js', array( 'jquery' ), '1.0.1', true );
		wp_enqueue_style( 'selectWoo', trailingslashit( WFACPKirki::$url ) . 'assets/vendor/selectWoo/css/selectWoo.css', array(), '1.0.1' );
		wp_enqueue_style( 'wfacpkirki-selectWoo', trailingslashit( WFACPKirki::$url ) . 'assets/vendor/selectWoo/kirki.css', null );
		...
		// Enqueue the style.
		wp_enqueue_style( 'wfacpkirki-styles', "{$wfacpkirki_url}controls/css/styles{$suffix}.css", array(), WFACP_KIRKI_VERSION );
	}
