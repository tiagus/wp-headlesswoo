...
class WFACPKirki_L10n {
	...
	public function __construct() {
		...
		// If WFACPKirki is installed as a plugin, load the texdomain.
	...
	public function override_load_textdomain( $override, $domain, $mofile ) {
		...
		if ( isset( $l10n[ $this->get_theme_textdomain() ] ) ) {
			...
			$l10n['wfacpkirki'] = $l10n[ $this->get_theme_textdomain() ];
		}

		// Check if the domain is "wfacpkirki".
		if ( 'wfacpkirki' === $domain ) {
			return true;
		}
		return $override;
