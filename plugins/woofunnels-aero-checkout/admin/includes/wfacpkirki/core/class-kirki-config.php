...
final class WFACPKirki_Config {
	...
	/**
	 * Set to true if you want to completely disable any WFACPKirki-generated CSS.
	 *
	 * @access protected
	 * @var bool
	 */
	 ...
	 *
	 * @access private
	 * @param string $config_id @see WFACPKirki_Config::get_instance().
	 * @param array  $args      @see WFACPKirki_Config::get_instance().
	 */
	private function __construct( $config_id = 'global', $args = array() ) {
		...
		// Apply any wfacpkirki_config global filters.
		$defaults = apply_filters( 'wfacpkirki_config', $defaults );
