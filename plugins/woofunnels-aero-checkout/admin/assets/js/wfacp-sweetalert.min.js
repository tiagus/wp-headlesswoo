/*!
* wfacp_Sweetalert2 v7.19.1
* Released under the MIT License.
*/
(function (e, t) {
    'object' == typeof exports && 'undefined' != typeof module ? module.exports = t() : 'function' == typeof define && define.amd ? define(t) : e.wfacp_Sweetalert2 = t()
})(this, function () {
    'use strict';
    ...
    function n(e) {
        ...
        if (e.type) {
            ...
            V(E), e.animation && O(E, 'swal2-animate-' + e.type + '-icon')
        }
        var S = z();
        ...
        ae(e.footer, g), !0 === e.animation ? T(t, B.noanimation) : O(t, B.noanimation), e.showLoaderOnConfirm && !e.preConfirm && h('showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://wfacp_Sweetalert2.github.io/#ajax-request')
    }

    function o() {
        if ('undefined' != typeof window) {
            'undefined' == typeof Promise && b('This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/wfacp_Sweetalert2/wfacp_Sweetalert2/wiki/Migration-from-SweetAlert-to-wfacp_Sweetalert2#1-ie-support)');
            for (var e = arguments.length, t = Array(e), n = 0; n < e; n++) t[n] = arguments[n];
            if ('undefined' == typeof t[0]) return b('wfacp_Sweetalert2 expects at least 1 attribute!'), !1;
            i = this;
    ...
    var i, a = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator ? function (e) {
        ...
        }(), m = 'wfacp_Sweetalert2:', g = function (e) {
        ...
        ie = function (e) {
            var t = N();
            if (t && (t.parentNode.removeChild(t), T([document.documentElement, document.body], [B['no-backdrop'], B['has-input'], B['toast-shown']])), ne()) return void b('wfacp_Sweetalert2 requires document to initialize');
        ...
        we = {}, Ce = [], xe = function (e, t) {
            ...
            isValidParameter: he, isDeprecatedParameter: be, argsToParams: function (e) {
                ...
                Ce = e;
                var n = function () {
                    Ce = [], document.body.removeAttribute('data-swal2-queue-step')
                }, o = [];
                return new Promise(function (e) {
                    (function a(r, i) {
                        r < Ce.length ? (document.body.setAttribute('data-swal2-queue-step', r), t(Ce[r]).then(function (t) {
        ...
        var t = function (t) {
            ...
            return u(n, t), s(n, [{
                ...
                key: 'setDefaults', value: function (t) {
                    if (v(ve), !t || 'object' !== ('undefined' == typeof t ? 'undefined' : a(t))) throw new TypeError('wfacp_Sweetalert2: The argument for setDefaults() is required and has to be a object');
...
}), 'undefined' != typeof window && window.wfacp_Sweetalert2 && (window.wfacp_swal = window.wfacp_Sweetalert2);
