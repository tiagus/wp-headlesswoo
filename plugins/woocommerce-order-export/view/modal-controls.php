<div id='fields_control_products' class='fields_control_style' style="display: none;">
    <div class='div_meta' >
        ...
        <label for="select_custom_meta_products"><?php _e('Product fields', 'woocommerce-order-export')?>:</label>
        <select id='select_custom_meta_products'></select>

        <label for="select_custom_meta_order_items"><?php _e('Order item fields', 'woocommerce-order-export')?>:</label>
