...
class WC_Order_Export_Manage {
	...
	static function get_days() {
		return array(
			'Sun'=>__( 'Sun', 'woocommerce-order-export' ),
			'Mon'=>__( 'Mon', 'woocommerce-order-export' ),
			'Tue'=>__( 'Tue', 'woocommerce-order-export' ),
			'Wed'=>__( 'Wed', 'woocommerce-order-export' ),
			'Thu'=>__( 'Thu', 'woocommerce-order-export' ),
			'Fri'=>__( 'Fri', 'woocommerce-order-export' ),
			'Sat'=>__( 'Sat', 'woocommerce-order-export' ),
		);
	}
	...
	static function apply_defaults( $mode, $settings ) {
		$defaults = array(
			...
			'format_xls_sheet_name'		       			 	 => __( 'Orders', 'woocommerce-order-export' ),
