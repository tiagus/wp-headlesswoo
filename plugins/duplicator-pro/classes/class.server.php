...
class DUP_PRO_Server 
{
    ...
    public static function getInstallerFiles() {
        ...
        return array(
            DUPLICATOR_PRO_INSTALL_PHP => DUPLICATOR_PRO_WPROOTPATH . $installer_base_name,
            ...
            'dup-wp-config-arc__[HASH].txt' => DUPLICATOR_PRO_WPROOTPATH . 'dup-wp-config-arc__*.txt',          
			'wp-config.duporig'		=> DUPLICATOR_PRO_WPROOTPATH . 'wp-config.duporig',

			// Required for Dupe Lite cleanup
			'installer-data.sql'	=> DUPLICATOR_PRO_WPROOTPATH . 'installer-data.sql',
            'installer-log.txt'		=> DUPLICATOR_PRO_WPROOTPATH . 'installer-log.txt',
            'database.sql'			=> DUPLICATOR_PRO_WPROOTPATH . 'database.sql',
            'dup-installer-data__[HASH].sql' => DUPLICATOR_PRO_WPROOTPATH . 'dup-installer-data__'.DUPLICATOR_PRO_INSTALLER_HASH_PATTERN.'.sql',
            'dup-database__[HASH].sql' => DUPLICATOR_PRO_WPROOTPATH . 'dup-database__'.DUPLICATOR_PRO_INSTALLER_HASH_PATTERN.'.sql',
            'dup-installer-log_[HASH].txt' => DUPLICATOR_PRO_WPROOTPATH . 'dup-installer-log__'.DUPLICATOR_PRO_INSTALLER_HASH_PATTERN.'.txt',
            'dup-installer-bootlog__[HASH].txt' => DUPLICATOR_PRO_WPROOTPATH .'dup-installer-bootlog__'.DUPLICATOR_PRO_INSTALLER_HASH_PATTERN.'.txt',
        );
    }
