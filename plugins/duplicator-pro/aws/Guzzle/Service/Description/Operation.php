...
class Operation implements OperationInterface
{
    ...
    const DEFAULT_COMMAND_CLASS = 'DuplicatorPro\\Guzzle\\Service\\Command\\OperationCommand';
     ...
     * 'DuplicatorPro\\Guzzle\\Foo\\Baz', or 'MyModelName' (to reference a model by ID).
     *
