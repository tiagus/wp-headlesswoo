...
class ParserRegistry
{
    ...
    protected $mapping = array(
        'message'      => 'DuplicatorPro\\Guzzle\\Parser\\Message\\MessageParser',
        'cookie'       => 'DuplicatorPro\\Guzzle\\Parser\\Cookie\\CookieParser',
        'url'          => 'DuplicatorPro\\Guzzle\\Parser\\Url\\UrlParser',
        'uri_template' => 'DuplicatorPro\\Guzzle\\Parser\\UriTemplate\\UriTemplate',
    );
    ...
    public function __construct()
    {
        ...
        if (extension_loaded('uri_template')) {
            $this->mapping['uri_template'] = 'DuplicatorPro\\Guzzle\\Parser\\UriTemplate\\PeclUriTemplate';
        }
    }
