...
use DuplicatorPro\Guzzle\Stream\StreamRequestFactoryInterface;
...
final class StaticClient
{
     ...
     * @param  array  $options Options to use with the request. See: DuplicatorPro\Guzzle\Http\Message\RequestFactory::applyOptions()
