...
use DuplicatorPro\Guzzle\Http\Exception\BadResponseException;
...
use DuplicatorPro\Guzzle\Http\Message\Header\HeaderInterface;
use DuplicatorPro\Guzzle\Http\Url;
use DuplicatorPro\Guzzle\Parser\ParserRegistry;
use DuplicatorPro\Symfony\Component\EventDispatcher\EventDispatcherInterface;
use DuplicatorPro\Symfony\Component\EventDispatcher\EventDispatcher;
...
class Request extends AbstractMessage implements RequestInterface
{
    ...
    /**
     * @deprecated Use DuplicatorPro\Guzzle\Plugin\Cache\DefaultCanCacheStrategy
     * @codeCoverageIgnore
     */
    public function canCache()
    {
        Version::warn(__METHOD__ . ' is deprecated. Use DuplicatorPro\Guzzle\Plugin\Cache\DefaultCanCacheStrategy.');
        if (class_exists('DuplicatorPro\Guzzle\Plugin\Cache\DefaultCanCacheStrategy')) {
