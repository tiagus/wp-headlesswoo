...
use DuplicatorPro\Guzzle\Http\Message\Header\HeaderCollection;
use DuplicatorPro\Guzzle\Http\Message\Header\HeaderFactory;
use DuplicatorPro\Guzzle\Http\Message\Header\HeaderFactoryInterface;
