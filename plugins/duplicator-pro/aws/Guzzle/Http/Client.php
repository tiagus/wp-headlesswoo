...
use DuplicatorPro\Guzzle\Common\Exception\ExceptionCollection;
...
use DuplicatorPro\Guzzle\Parser\UriTemplate\UriTemplateInterface;
use DuplicatorPro\Guzzle\Http\Message\RequestInterface;
use DuplicatorPro\Guzzle\Http\Message\RequestFactory;
use DuplicatorPro\Guzzle\Http\Message\RequestFactoryInterface;
use DuplicatorPro\Guzzle\Http\Curl\CurlMultiInterface;
use DuplicatorPro\Guzzle\Http\Curl\CurlMultiProxy;
use DuplicatorPro\Guzzle\Http\Curl\CurlHandle;
use DuplicatorPro\Guzzle\Http\Curl\CurlVersion;
