...
use DuplicatorPro\Aws\S3\Exception\NoSuchKeyException;
use DuplicatorPro\Aws\S3\Iterator\ListObjectsIterator;
use DuplicatorPro\Guzzle\Http\EntityBody;
use DuplicatorPro\Guzzle\Http\CachingEntityBody;
use DuplicatorPro\Guzzle\Http\Mimetypes;
use DuplicatorPro\Guzzle\Iterator\FilterIterator;
use DuplicatorPro\Guzzle\Stream\PhpStreamRequestFactory;
...
class StreamWrapper
{
    ...
    protected function openReadStream(array $params, array &$errors)
    {
        ...
        $this->body = $factory->fromRequest($request, array(), array('stream_class' => 'DuplicatorPro\Guzzle\Http\EntityBody'));
