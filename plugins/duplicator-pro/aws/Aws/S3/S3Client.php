...
use DuplicatorPro\Aws\Common\Client\UploadBodyListener;
...
use DuplicatorPro\Aws\S3\Exception\AccessDeniedException;
use DuplicatorPro\Aws\S3\Exception\Parser\S3ExceptionParser;
use DuplicatorPro\Aws\S3\Exception\S3Exception;
use DuplicatorPro\Aws\S3\Model\ClearBucket;
use DuplicatorPro\Aws\S3\Model\MultipartUpload\AbstractTransfer as AbstractMulti;
use DuplicatorPro\Aws\S3\Model\MultipartUpload\UploadBuilder;
use DuplicatorPro\Aws\S3\Sync\DownloadSyncBuilder;
use DuplicatorPro\Aws\S3\Sync\UploadSyncBuilder;
...
use DuplicatorPro\Guzzle\Iterator\FilterIterator;
...
use DuplicatorPro\Guzzle\Service\Command\Factory\AliasFactory;
use DuplicatorPro\Guzzle\Service\Command\Factory\CompositeFactory;
use DuplicatorPro\Guzzle\Service\Resource\Model;
use DuplicatorPro\Guzzle\Service\Resource\ResourceIteratorInterface;
...
class S3Client extends AbstractClient
{
    ...
    public static function factory($config = array())
    {
        ...
        $default->add(
            ...
            'DuplicatorPro\Guzzle\Service\Command\Factory\ServiceDescriptionFactory'
        );
     ...
     * @param mixed  $body    Object data to upload. Can be a DuplicatorPro\Guzzle\Http\EntityBodyInterface, stream resource, or
     ...
     *       DuplicatorPro\Guzzle\Common\Event object with context.
     *
     * @see DuplicatorPro\Aws\S3\Model\MultipartUpload\UploadBuilder for more options and customization
     ...
     *       multipart upload.
     *
     * @see DuplicatorPro\Aws\S3\S3Sync\S3Sync for more options and customization
     */
     ...
     *       DuplicatorPro\Guzzle\Common\Event object with context.
     *
     * @see DuplicatorPro\Aws\S3\S3Client::listObjects
     * @see DuplicatorPro\Aws\S3\Model\ClearBucket For more options or customization
     * @return int Returns the number of deleted keys
