...
$admin_redirect = (($GLOBALS['DUPX_AC']->mu_mode > 0) && ($_POST['subsite_id'] == -1))
	? "{$url_new_rtrim}/wp-admin/network/admin.php?page=duplicator-pro-tools&tab=d"
	: "{$url_new_rtrim}/wp-admin/admin.php?page=duplicator-pro-tools&tab=d";
...
These values should only be investigated if your running into issues with your site.
