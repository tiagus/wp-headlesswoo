 ...
 */
class Duplicator_Pro_Google_Config
{
  ...
  /**
   * Create a new Duplicator_Pro_Google_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'Duplicator_Pro_Google_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'Duplicator_Pro_Google_Cache_File',
      'logger_class'  => 'Duplicator_Pro_Google_Logger_Null',
      ...
      'classes' => array(
        'Duplicator_Pro_Google_IO_Abstract' => array(
          'request_timeout_seconds' => 1000,
        ),
        'Duplicator_Pro_Google_IO_Curl' => array(
          'disable_proxy_workaround' => false,
          'options' => null,
        ),
        'Duplicator_Pro_Google_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'Duplicator_Pro_Google_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'Duplicator_Pro_Google_Http_Request' => array(
        ...
        'Duplicator_Pro_Google_Auth_OAuth2' => array(
        ...
        'Duplicator_Pro_Google_Task_Runner' => array(
        ...
        'Duplicator_Pro_Google_Service_Exception' => array(
          'retry_map' => array(
        ...
        'Duplicator_Pro_Google_IO_Exception' => array(
        ...
        'Duplicator_Pro_Google_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/Duplicator_Pro_Google_Client'
        )
      ),
    );
