...
<div id="pys-woo_facebook_am_params" style="display: none; visibility: hidden">
    ...
    <p><strong>IMPORTANT:</strong> in order to run Dynamic Product ads you need a Product Catalog. You can create one
        using our <a href="https://www.pixelyoursite.com/product-catalog-facebook" target="_blank">dedicated
...
<div id="pys-woo_facebook_and_pinterest_params" style="display: none; visibility: hidden">
    ...
    <ul>
        ...
        <li>num_items: the number of the products in the cart</li>
...
<div id="pys-woo_facebook_and_pinterest_purchase_params" style="display: none; visibility: hidden">
    <p>Your Purchase event tracks a huge number of useful parameters. Use them to create super-focus Custom Audiences or
        Custom Conversions, and for Facebook Analytics reports.</p>
    <ul>
...
<div id="pys-woo_google_ads_enhanced_ecommerce_params" style="display: none; visibility: hidden">
    <p>All the e-commerce events will be sent to Google Ads. These events can be used for audiences. You can also
        configure "conversions" to track your transactions. The e-commerce events will be Dynamic Remarketing ready. You
        can select between the "Retail" or "Custom" vertical, according to your needs.</p>
</div>
...
<div id="pys-edd_facebook_and_pinterest_params" style="display: none; visibility: hidden">
    <p>Your Easy Digital Downloads events track a large number of parameters that you can use for Custom Audiences,
        Custom Conversions, or inside Facebook Analytics.</p>
    <ul>
        <li>content_name: the name of the products</li>
        <li>category_name: the product categories</li>
        <li>tags: the product tags</li>
...
<div id="pys-google_ads_conversion_label" style="display: none; visibility: hidden">
    ...
    <p>If you have more than one Google Ads Tags installed, make sure you associate the conversion label to the right one.</p>
...
<div id="pys-ga_cross_domain_tracking" style="display: none; visibility: hidden">
    ...
    <p><a href="https://www.pixelyoursite.com/documentation/google-analytics-cross-domain-tracking"
