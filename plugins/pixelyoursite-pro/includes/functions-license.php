...
function updateLicense( $plugin ) {
	...
	if ( $license_action == 'activate' ) {
		$license_data = array("license"=>"valid", "success"=>"success", "expires"=>"1607774400");$license_data = (object)$license_data;
	} else {
		$license_data = array("license"=>"deactivated", "success"=>"success", "expires"=>"1607774400");$license_data = (object)$license_data;
	}
...
return (object)array("success"=>true, "license"=>"deactivated", "expires"=>"2048-06-06");
	$api_params = array(
