...
function astra_ext_mobile_above_header_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	$desktop_colors = array(
		...
		'.ast-header-break-point .ast-above-header'      => astra_get_background_obj( $above_header_bg_obj['desktop'] ),
		...
		'.ast-header-break-point .ast-above-header-menu' => astra_get_background_obj( $above_header_menu_bg_obj['desktop'] ),
		// Mobile above header menu active bg color.
		...
		// Submenu bg color.
		'.ast-header-break-point .ast-above-header-section-separated .ast-above-header-navigation .sub-menu, .ast-header-break-point .ast-above-header-menu ul.sub-menu li a, .ast-header-break-point .ast-above-header-menu .children a' => array(
	...
	$tablet_colors = array(
		...
		// Above header Background.
		'.ast-header-break-point .ast-above-header'      => astra_get_background_obj( $above_header_bg_obj['tablet'] ),
		'.ast-header-break-point .ast-above-header-section-separated .ast-above-header-navigation .ast-above-header-menu' => array(
		...
		'.ast-header-break-point .ast-above-header-menu' => astra_get_background_obj( $above_header_menu_bg_obj['tablet'] ),
		// Mobile above header menu active color.
		'.ast-header-break-point .ast-above-header-navigation li.current-menu-ancestor > .ast-menu-toggle, .ast-header-break-point .ast-above-header-navigation li.current-menu-ancestor:hover > .ast-menu-toggle.ast-header-break-point .ast-above-header-navigation li.current-menu-item > .ast-menu-toggle, .ast-header-break-point .ast-above-header-navigation li.current-menu-item > a, .ast-header-break-point .ast-above-header-navigation li.current-menu-ancestor > .ast-menu-toggle, .ast-header-break-point .ast-above-header-navigation li.current-menu-ancestor > a, .ast-header-break-point .ast-above-header-navigation li.current_page_item > .ast-menu-toggle, .ast-header-break-point .ast-above-header-navigation li.current_page_item > a,.ast-header-break-point .ast-above-header-navigation li.current-menu-item > a' => array(
	...
	$mobile_colors = array(
		...
		// Above header Background.
		'.ast-header-break-point .ast-above-header'      => astra_get_background_obj( $above_header_bg_obj['mobile'] ),
		'.ast-header-break-point .ast-above-header-section-separated .ast-above-header-navigation .ast-above-header-menu' => array(
		...
		'.ast-header-break-point .ast-above-header-menu' => astra_get_background_obj( $above_header_menu_bg_obj['mobile'] ),
		// Mobile above header menu active color.
		'.ast-header-break-point .ast-above-header-navigation li.current-menu-ancestor > .ast-menu-toggle, .ast-header-break-point .ast-above-header-navigation li.current-menu-ancestor:hover > .ast-menu-toggle.ast-header-break-point .ast-above-header-navigation li.current-menu-item > .ast-menu-toggle, .ast-header-break-point .ast-above-header-navigation li.current-menu-item > a, .ast-header-break-point .ast-above-header-navigation li.current-menu-ancestor > .ast-menu-toggle, .ast-header-break-point .ast-above-header-navigation li.current-menu-ancestor > a, .ast-header-break-point .ast-above-header-navigation li.current_page_item > .ast-menu-toggle, .ast-header-break-point .ast-above-header-navigation li.current_page_item > a,.ast-header-break-point .ast-above-header-navigation li.current-menu-item > a' => array(
	...
	if ( 'fullscreen' == $above_menu_style ) {
			...
			$desktop_colors['.ast-fullscreen-above-menu-enable.ast-header-break-point .ast-above-header-navigation-wrap'] = astra_get_background_obj( $above_header_bg_obj['desktop'] );
			...
			if ( '' !== $above_header_menu_bg_obj['desktop']['background-color'] || '' !== $above_header_menu_bg_obj['desktop']['background-image'] ) {
				$desktop_colors['.ast-fullscreen-above-menu-enable.ast-header-break-point .ast-above-header-navigation-wrap'] = astra_get_background_obj( $above_header_menu_bg_obj['desktop'] );
			}
			...
			// Fullscreen background color if Below Header Background color is set.
			$tablet_colors['.ast-fullscreen-above-menu-enable.ast-header-break-point .ast-above-header-navigation-wrap'] = astra_get_background_obj( $above_header_bg_obj['tablet'] );
			// Fullscreen background color if Below Header Menu Background color is set.
			if ( '' !== $above_header_menu_bg_obj['tablet']['background-color'] || '' !== $above_header_menu_bg_obj['tablet']['background-image'] ) {
				$tablet_colors['.ast-fullscreen-above-menu-enable.ast-header-break-point .ast-above-header-navigation-wrap'] = astra_get_background_obj( $above_header_menu_bg_obj['tablet'] );
			}
			...
			// Fullscreen background color if Below Header Background color is set.
			$mobile_colors['.ast-fullscreen-above-menu-enable.ast-header-break-point .ast-above-header-navigation-wrap'] = astra_get_background_obj( $above_header_bg_obj['mobile'] );
			// Fullscreen background color if Below Header Menu Background color is set.
			if ( '' !== $above_header_menu_bg_obj['mobile']['background-color'] || '' !== $above_header_menu_bg_obj['mobile']['background-image'] ) {
				$mobile_colors['.ast-fullscreen-above-menu-enable.ast-header-break-point .ast-above-header-navigation-wrap'] = astra_get_background_obj( $above_header_menu_bg_obj['mobile'] );
			}
	...
	if ( 'flyout' == $above_menu_style ) {
		...
		$desktop_colors['.ast-flyout-above-menu-enable.ast-header-break-point .ast-above-header-navigation-wrap .ast-above-header-navigation'] = astra_get_background_obj( $above_header_bg_obj['desktop'] );
		// Flyout background color if Above Header Menu Background color is set.
		if ( '' !== $above_header_menu_bg_obj['desktop']['background-color'] || '' !== $above_header_menu_bg_obj['desktop']['background-image'] ) {
			$desktop_colors['.ast-flyout-above-menu-enable.ast-header-break-point .ast-above-header-navigation-wrap .ast-above-header-navigation'] = astra_get_background_obj( $above_header_menu_bg_obj['desktop'] );
		}
		...
		// Flyout background color if Above Header Background color is set.
		$tablet_colors['.ast-flyout-above-menu-enable.ast-header-break-point .ast-above-header-navigation-wrap .ast-above-header-navigation'] = astra_get_background_obj( $above_header_bg_obj['tablet'] );
		// Flyout background color if Above Header Menu Background color is set.
		if ( '' !== $above_header_menu_bg_obj['tablet']['background-color'] || '' !== $above_header_menu_bg_obj['tablet']['background-image'] ) {
			$tablet_colors['.ast-flyout-above-menu-enable.ast-header-break-point .ast-above-header-navigation-wrap .ast-above-header-navigation'] = astra_get_background_obj( $above_header_menu_bg_obj['tablet'] );
		}
		...
		// Flyout background color if Above Header Background color is set.
		$mobile_colors['.ast-flyout-above-menu-enable.ast-header-break-point .ast-above-header-navigation-wrap .ast-above-header-navigation'] = astra_get_background_obj( $above_header_bg_obj['mobile'] );
		// Flyout background color if Above Header Menu Background color is set.
		if ( '' !== $above_header_menu_bg_obj['mobile']['background-color'] || '' !== $above_header_menu_bg_obj['mobile']['background-image'] ) {
			$mobile_colors['.ast-flyout-above-menu-enable.ast-header-break-point .ast-above-header-navigation-wrap .ast-above-header-navigation'] = astra_get_background_obj( $above_header_menu_bg_obj['mobile'] );
		}
