...
function astra_ext_mobile_below_header_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	$desktop_colors = array(
		...
		'.ast-header-break-point .ast-below-header' => astra_get_background_obj( $below_header_obj['desktop'] ),
	...
	$tablet_colors = array(
		// Mobile below header Background Image.
		'.ast-header-break-point .ast-below-header' => astra_get_background_obj( $below_header_obj['tablet'] ),
		// Mobile below header text color.
		'.ast-header-break-point .below-header-user-select,.ast-header-break-point .below-header-user-select .widget' => array(
	...
	$mobile_colors = array(
		// Mobile below header Background Image.
		'.ast-header-break-point .ast-below-header' => astra_get_background_obj( $below_header_obj['mobile'] ),
		// Mobile below header text color.
		'.ast-header-break-point .below-header-user-select,.ast-header-break-point .below-header-user-select .widget' => array(
	...
	if ( 'fullscreen' == $below_menu_style ) {
			...
			$desktop_colors['.ast-fullscreen-below-menu-enable.ast-header-break-point .ast-below-header-navigation-wrap'] = astra_get_background_obj( $below_header_obj['desktop'] );
			...
			// Fullscreen background color if Below Header Background color is set.
			$tablet_colors['.ast-fullscreen-below-menu-enable.ast-header-break-point .ast-below-header-navigation-wrap'] = astra_get_background_obj( $below_header_obj['tablet'] );
			// Fullscreen background color if Below Header Menu Background color is set.
			...
			// Fullscreen background color if Below Header Background color is set.
			$mobile_colors['.ast-fullscreen-below-menu-enable.ast-header-break-point .ast-below-header-navigation-wrap'] = astra_get_background_obj( $below_header_obj['mobile'] );
			// Fullscreen background color if Below Header Menu Background color is set.
	...
	if ( 'flyout' == $below_menu_style ) {
		...
		$desktop_colors['.ast-flyout-below-menu-enable.ast-header-break-point .ast-below-header-navigation-wrap .ast-below-header-actual-nav'] = astra_get_background_obj( $below_header_obj['desktop'] );
		...
		// Flyout background color if Header Background color is set.
		$tablet_colors['.ast-flyout-below-menu-enable.ast-header-break-point .ast-below-header-navigation-wrap .ast-below-header-actual-nav'] = astra_get_background_obj( $below_header_obj['tablet'] );
		// Flyout background color if Primary Menu Background color is set.
		if ( '' !== $below_header_menu_bg_obj['tablet']['background-color'] || '' !== $below_header_menu_bg_obj['tablet']['background-image'] ) {
		...
		// Flyout background color if Header Background color is set.
		$mobile_colors['.ast-flyout-below-menu-enable.ast-header-break-point .ast-below-header-navigation-wrap .ast-below-header-actual-nav'] = astra_get_background_obj( $below_header_obj['mobile'] );
