...
if ( ! class_exists( 'Astra_Ext_Sticky_Header_Markup' ) ) {
	...
	class Astra_Ext_Sticky_Header_Markup {
		 ...
		 */
		function none_custom_logo( $html ) {
		 ...
		 * @return String          Custom logo HTML output
		 */
		function sticky_custom_logo( $html, $blog_id ) {
			$header_logo = astra_get_option( 'sticky-header-logo' );
		 ...
		 */
		function sticky_replace_header_logo_attr( $attr, $attachment, $size ) {
		 ...
		 * @return array
		 */
		function sticky_logo_image_sizes( $sizes, $metadata ) {
