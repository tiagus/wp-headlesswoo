...
function astra_ext_above_header_sections_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	if ( 'none' === $sticky_header_style && ! $sticky_hide_on_scroll ) {
		$desktop_above_header_css_output = array(
			...
			'.ast-above-sticky-header-active .ast-above-header-navigation a'                => array(
			 ...
			 */
			'.ast-above-sticky-header-active .ast-above-header-menu .sub-menu li:hover > a, .ast-above-sticky-header-active .ast-above-header-menu .sub-menu li:focus > a, .ast-above-sticky-header-active .ast-above-header-menu .sub-menu li.focus > a,.ast-above-sticky-header-active .ast-above-header-menu .sub-menu li:hover > .ast-menu-toggle, .ast-above-sticky-header-active .ast-above-header-menu .sub-menu li:focus > .ast-menu-toggle, .ast-above-sticky-header-active .ast-above-header-menu .sub-menu li.focus > .ast-menu-toggle' => array(
		...
		$desktop_above_header_css_output = array(
			...
			'#ast-fixed-header .ast-above-header-navigation a' => array(
				'color' => esc_attr( $sticky_above_header_menu_color_responsive['desktop'] ),
			),
			 ...
			 * Above Header Dropdown Navigation
			 */
			'#ast-fixed-header .ast-above-header-menu .sub-menu li:hover > a, #ast-fixed-header .ast-above-header-menu .sub-menu li:focus > a, #ast-fixed-header .ast-above-header-menu .sub-menu li.focus > a,#ast-fixed-header .ast-above-header-menu .sub-menu li:hover > .ast-menu-toggle, #ast-fixed-header .ast-above-header-menu .sub-menu li:focus > .ast-menu-toggle, #ast-fixed-header .ast-above-header-menu .sub-menu li.focus > .ast-menu-toggle' => array(
				'color'            => esc_attr( $sticky_above_header_submenu_h_color_responsive['desktop'] ),
				'background-color' => esc_attr( $sticky_above_header_submenu_h_a_bg_color_responsive['desktop'] ),
			),
			'#ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-ancestor > .ast-menu-toggle, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-item > .ast-menu-toggle, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-ancestor:hover > .ast-menu-toggle, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-ancestor:focus > .ast-menu-toggle, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-ancestor.focus > .ast-menu-toggle, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-item:hover > .ast-menu-toggle, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-item:focus > .ast-menu-toggle, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-item.focus > .ast-menu-toggle' => array(
				'color' => esc_attr( $sticky_above_header_submenu_h_color_responsive['desktop'] ),
			),
			'#ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-ancestor > a, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-item > a, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-ancestor:hover > a, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-ancestor:focus > a, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-ancestor.focus > a, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-item:hover > a, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-item:focus > a, #ast-fixed-header .ast-above-header-menu .sub-menu li.current-menu-item.focus > a' => array(
				'color'            => esc_attr( $sticky_above_header_submenu_h_color_responsive['desktop'] ),
				'background-color' => esc_attr( $sticky_above_header_submenu_h_a_bg_color_responsive['desktop'] ),
			),
		...
		$parse_css .= astra_parse_css( $tablet_above_header_css_output, '', '768' );
		$parse_css .= astra_parse_css( $mobile_above_header_css_output, '', '544' );
...
function astra_ext_below_header_sections_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	if ( 'none' === $sticky_header_style && ! $sticky_hide_on_scroll ) {
		$desktop_below_header_css_output = array(
			...
			'.ast-below-sticky-header-active .ast-below-header-actual-nav' => array(
		...
		$parse_css .= astra_parse_css( $tablet_below_header_css_output, '', '768' );
		$parse_css .= astra_parse_css( $mobile_below_header_css_output, '', '544' );
