...
function astra_ext_mega_menu_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	if ( Astra_Ext_Extension::is_active( 'colors-and-background' ) ) {
		...
		if ( Astra_Ext_Extension::is_active( 'header-sections' ) ) {
			...
			$css .= astra_parse_css( $tablet_colors, '', '768' );
			$css .= astra_parse_css( $mobile_colors, '', '544' );
		...
		$colors                                 = array(
			...
			'.ast-desktop .ast-mega-menu-enabled.main-header-menu .menu-item-heading > a:hover' => array(
				'color' => esc_attr( $primary_mega_menu_heading_h_color ),
			),

			// Sticky Primary Header.
			'.ast-desktop.ast-primary-sticky-header-active .ast-mega-menu-enabled.main-header-menu .menu-item-heading > a' => array(
				'color' => esc_attr( $sticky_mega_menu_heading_color ),
			),
			'.ast-desktop.ast-primary-sticky-header-active .ast-mega-menu-enabled.main-header-menu .menu-item-heading > a:hover' => array(
			...
			// Sticky Below Header.
			'.ast-desktop.ast-below-sticky-header-active .ast-mega-menu-enabled.ast-below-header-menu .menu-item-heading > a' => array(
	...
	$css .= astra_parse_css( $mobile_spacing, '', '544' );
	$css .= astra_parse_css( $tablet_spacing, '', '768' );
