		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			if ( 0 === $depth && '' != $this->megamenu ) {
				...
				if ( 'full' === $this->megamenu_width ) {
					$output .= "\n$indent<div class='astra-full-megamenu-wrapper " . esc_attr( $megamenu_divider_class ) . "'>\n";
				}
				$output .= "\n$indent<ul class='astra-megamenu sub-menu astra-mega-menu-width-{$this->megamenu_width}" . esc_attr( $megamenu_divider_class ) . "'>\n";
