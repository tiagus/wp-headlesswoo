                        ...
                        <table>
                            ...
                            <tr class="deps-rules_type" data-type="exclude_disc_sale">
                                <td>
	                                ...
	                                ?>
                                    <select name="<?php echo $name . "[{$i}][rules_type_exclude_disc_sale]"?>" id="<?php echo $id . "[{$i}][rules_type_exclude_disc_sale]"?>">
                                        <option value="no" <?php selected('no', $value )?>><?php _e('No', 'ywdpd') ?></option>
                                        <option value="yes" <?php selected('yes', $value )?>><?php _e('Yes', 'ywdpd') ?></option>
                                    </select>
                                </td>
                            </tr>
