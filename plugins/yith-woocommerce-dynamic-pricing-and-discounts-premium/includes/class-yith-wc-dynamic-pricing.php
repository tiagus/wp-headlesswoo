...
if ( ! class_exists( 'YITH_WC_Dynamic_Pricing' ) ) {
	...
	class YITH_WC_Dynamic_Pricing {
		...
		public function __construct() {
			...
			add_filter( 'ywdpd_change_dynamic_price', array(
				$this,
...
//                	error_log('available_quantity '.$cart_item['available_quantity']);
					...
					if ( $dm['same_product'] && ( in_array( $dm['quantity_based'], array(
							'cart_line',
			...
			add_filter( 'woocommerce_' . YITH_WC_Dynamic_Pricing_Frontend()->get_product_filter . 'get_price', array(
				YITH_WC_Dynamic_Pricing_Frontend(),
				'get_price'
			), 10, 2 );
